...
export const AUCTION_EXPLANATION =
  "SEM-DA is the day ahead auction, usually published by around midday the day before delivery and setting the first price for every half hour of the next day. SEM-IDA1, SEM-IDA2, and SEM-IDA3 are three further intraday auctions held later on the day itself, each repricing the same settlement periods with more up to date information. A higher number means a more recent revision, so SEM-IDA3 — where a period has one — is the closest to real time.";
