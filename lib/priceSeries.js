...
export const PROVISIONAL_EXPLANATION =
  "Provisional prices are sourced from an undocumented SEMOpx feed, not yet formally published as an official result. They're real auction data, not an estimate, but SEMOpx's own erroneous bid correction process means a provisional figure could still be revised before the official one lands. Shown only for today, and only when you turn this on.";
